...
if show_feedback:
    ...
    if st.button("Kirim"):
        if feedback.strip() != "":
            ...
            bot_token = '7580961854:AAHPh-nX8n9_U-L7kCvwautmkRnF92UCD84'  # ganti dengan token kamu
            chat_id = '7580961854'  # ganti dengan ID chat/penerima (bisa ID user atau group)
