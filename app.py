    ...
    with st.spinner("⏳ Memproses data..."):
        ...
        if not combined_df.empty:
            ...
            <div class="stat-box">
                ...
                <ul>
                    <li>Total produk diproses: <strong style="color:#00ff00;">{total_links}</strong></li>
                    <li>Produk unik setelah hapus duplikat: <strong style="color:#00ff00;">{len(combined_df)}</strong></li>
                    <li>Produk lolos filter: <strong style="color:#00ff00;">{len(filtered_df)}</strong></li>
                    <li>Produk tidak lolos filter: <strong style="color:#00ff00;">{len(removed_df)}</strong></li>
                    <li>Duplikat yang dihapus: <strong style="color:#00ff00;">{deleted_dupes}</strong></li>
                </ul>
            </div>
            """, unsafe_allow_html=True)
